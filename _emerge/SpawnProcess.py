...
from pkgwh.const import BASH_BINARY
...
class SpawnProcess(SubProcess):
	...
	"""
	Constructor keyword args are passed into pkgwh.process.spawn().
	...
	def _spawn(self, args, **kwargs):
		spawn_func = pkgwh.process.spawn

		if self._selinux_type is not None:
			spawn_func = pkgwh.selinux.spawn_wrapper(spawn_func,
				self._selinux_type)
