...
import pkgwh
from pkgwh import _encodings, _unicode_encode, os
from pkgwh.package.ebuild.digestcheck import digestcheck
from pkgwh.package.ebuild.doebuild import _check_temp_dir
from pkgwh.package.ebuild._spawn_nofetch import SpawnNofetchWithoutBuilddir
...
class EbuildBuild(CompositeTask):
	...
	def _start_with_metadata(self, aux_get_task):
		...
		pkgwh.doebuild_environment(ebuild_path, 'setup',
	...
	def _pre_clean_exit(self, pre_clean_phase):
		...
		# for log handling
		pkgwh.prepare_build_dirs(self.pkg.root, self.settings, 1)
	...
	def _build_exit(self, build):
		...
		for pkg_fmt in pkgwh.const.SUPPORTED_BINPKG_FORMATS:
