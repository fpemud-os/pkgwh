...
import pkgwh
from pkgwh.elog import messages as elog_messages
from pkgwh.localization import _
from pkgwh.package.ebuild._ipc.ExitCommand import ExitCommand
...
from pkgwh.util import apply_secpass_permissions

pkgwh.proxy.lazyimport.lazyimport(globals(),
	'pkgwh.package.ebuild.doebuild:_global_pid_phases',
)
