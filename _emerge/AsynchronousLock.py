...
class AsynchronousLock(AsynchronousTask):
	"""
	This uses the pkgwh.locks module to acquire a lock asynchronously,
	...
	def _start(self):
		...
		self._proc = SpawnProcess(
			args=[pkgwh._python_interpreter,
				os.path.join(pkgwh._bin_path, 'lock-helper.py'), self.path],
				env=dict(os.environ, PORTAGE_PYM_PATH=pkgwh._pym_path),
