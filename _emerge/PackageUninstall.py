...
from pkgwh.dbapi._MergeProcess import MergeProcess
from pkgwh.exception import UnsupportedAPIException
...
class PackageUninstall(CompositeTask):
	...
	subprocess, since the pkgwh.locks module does not behave
	...
	def _start(self):
		...
		cat, pf = pkgwh.catsplit(self.pkg.cpv)
		myebuildpath = os.path.join(dbdir, pf + ".ebuild")

		try:
			pkgwh.doebuild_environment(myebuildpath, "prerm",
