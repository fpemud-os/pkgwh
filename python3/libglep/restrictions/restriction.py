...
class AlwaysBool(base):
    ...
    def __init__(self, node_type=None, negate=False):
        ...
        :param node_type: the restriction type the instance should be,
            typically :obj:`pkgwh.core.restrictions.restriction.package_type` or
            :obj:`pkgwh.core.restrictions.restriction.value_type`
...
class Negate(base):
    ...
    def __init__(self, restrict):
        """
        :param restrict: :obj:`pkgwh.core.restrictions.restriction.base` instance to negate
        """
...
class FakeType(base):
    ...
    def __init__(self, restrict, new_type):
        """
        :param restrict: :obj:`pkgwh.core.restrictions.restriction.base` instance to wrap
