...
import pkgwh
from pkgwh import bsd_chflags, _encodings, _os_overrides, _selinux, \
	_unicode_decode, _unicode_encode, _unicode_func_wrapper, \
	_unicode_module_wrapper
from pkgwh.const import MOVE_BINARY
from pkgwh.exception import OperationNotSupported
from pkgwh.localization import _
from pkgwh.process import spawn
from pkgwh.util import writemsg
from pkgwh.util._xattr import xattr
from pkgwh.util.file_copy import copyfile
...
def movefile(src, dest, newmtime=None, sstat=None, mysettings=None,
	...
	lchown = _unicode_func_wrapper(pkgwh.data.lchown, encoding=encoding)
