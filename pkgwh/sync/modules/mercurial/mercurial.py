...
class MercurialSync(NewBase):
	...
	def __init__(self):
		NewBase.__init__(self, "hg", pkgwh.const.HG_PACKAGE_ATOM)
	...
	def update(self):
		...
		previous_rev = subprocess.check_output(
			rev_cmd, cwd=pkgwh._unicode_encode(self.repo.location)
		)
