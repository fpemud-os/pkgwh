...
from pkgwh.sync.syncbase import SyncBase
...
class WebRsync(SyncBase):
	...
	def has_bin(self):
		if (self._bin_command != 'emerge-delta-webrsync' and
			...
			self.bin_command = pkgwh.process.find_binary(self._bin_command)
	...
	def sync(self, **kwargs):
		...
		try:
			...
			exitcode = pkgwh.process.spawn(webrsync_cmd, **self.spawn_kwargs)
