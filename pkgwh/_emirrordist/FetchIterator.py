...
from pkgwh.checksum import (_apply_hash_filter,
...
def _async_fetch_tasks(config, hash_filter, repo_config, digests_future, cpv,
	...
	@type config: pkgwh._emirrordist.Config.Config
	@param hash_filter: PORTAGE_CHECKSUM_FILTER settings
	@type hash_filter: pkgwh.checksum._hash_filter
	...
	@type cpv: pkgwh.versions._pkg_str
