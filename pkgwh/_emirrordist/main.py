...
from pkgwh.util import normalize_path, _recursive_file_list
...
def emirrordist_main(args):
	...
	settings = pkgwh.config(config_root=config_root,
	...
	portdb = pkgwh.portdbapi(mysettings=settings)

	# Limit ebuilds to the specified repo.
	portdb.porttrees = [repo_path]

	pkgwh.util.initialize_logger()
