...
import pkgwh
from pkgwh.cache import fs_template
from pkgwh.cache import cache_errors
...
class database(fs_template.FsBased):
	...
	@property
	def _db_cursor(self):
		if self._db_connection_info is None or self._db_connection_info.pid != pkgwh.getpid():
	...
	def _db_init_connection(self):
		...
		try:
			...
			self._db_connection_info = self._connection_info_entry(connection, cursor, pkgwh.getpid())
