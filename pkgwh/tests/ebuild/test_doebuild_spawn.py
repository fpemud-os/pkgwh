...
from pkgwh import _python_interpreter
from pkgwh import _shell_quote
from pkgwh.const import EBUILD_SH_BINARY
from pkgwh.package.ebuild.config import config
from pkgwh.package.ebuild.doebuild import spawn as doebuild_spawn
...
class DoebuildSpawnTestCase(TestCase):
	"""
	Invoke pkgwh.package.ebuild.doebuild.spawn() with a
