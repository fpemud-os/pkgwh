...
from pkgwh.const import (BASH_BINARY, BINREPOS_CONF_FILE, PORTAGE_PYM_PATH, USER_CONFIG_PATH)
...
from pkgwh.util import (ensure_dirs, find_updated_config_files,
	shlex_split)
