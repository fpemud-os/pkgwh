...
from pkgwh.const import MANIFEST2_HASH_DEFAULTS
from pkgwh.dbapi.porttree import FetchlistDict
from pkgwh.dep import use_reduce
from pkgwh.exception import InvalidDependString, FileNotFound, \
	PermissionDenied, PortagePackageException
from pkgwh.localization import _
from pkgwh.output import colorize
from pkgwh.package.ebuild.fetch import fetch
from pkgwh.util import writemsg, writemsg_stdout
...
def digestgen(myarchives=None, mysettings=None, myportdb=None):
	...
	if mysettings is None or myportdb is None:
		raise TypeError("pkgwh.digestgen(): 'mysettings' and 'myportdb' parameter are required.")
