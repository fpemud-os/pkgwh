...
import pkgwh.util.formatter as formatter

from pkgwh import os
from pkgwh import _encodings
from pkgwh import _unicode_encode
from pkgwh import _unicode_decode
from pkgwh.const import COLOR_MAP_FILE
from pkgwh.exception import CommandNotFound, FileNotFound, \
...
class _LazyInitColorMap(pkgwh.proxy.objectproxy.ObjectProxy):
