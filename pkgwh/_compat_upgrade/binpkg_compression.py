...
def main():
	...
	pkg_preinst() {
		...
		env -u BINPKG_COMPRESS
			...
			"${PYTHON}" -m pkgwh._compat_upgrade.binpkg_compression || die
	}
	"""
	if pkgwh.settings.get('BINPKG_COMPRESS', COMPAT_BINPKG_COMPRESS) == COMPAT_BINPKG_COMPRESS:
		...
		with open(config_path) as f:
			...
			pkgwh.output.EOutput().einfo('Setting make.globals default {} for backward compatibility'.format(compat_setting))
