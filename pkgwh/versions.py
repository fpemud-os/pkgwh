...
pkgwh.proxy.lazyimport.lazyimport(globals(),
	'pkgwh.repository.config:_gen_valid_repo',
	'pkgwh.util:cmp_sort_key',
)
from pkgwh import _unicode_decode
from pkgwh.eapi import _get_eapi_attrs
from pkgwh.exception import InvalidData
...
def vercmp(ver1, ver2, silent=1):
	...
	Example usage:
		>>> from pkgwh.versions import vercmp
	...
	@param pkg1: version to compare with (see ver_regexp in pkgwh.versions.py)
	@type pkg1: string (example: "2.1.2-r3")
	@param pkg2: version to compare againts (see ver_regexp in pkgwh.versions.py)
	...
	4. None if ver1 or ver2 are invalid (see ver_regexp in pkgwh.versions.py)
	"""
...
def cpv_getkey(mycpv, eapi=None):
	...
	warnings.warn("pkgwh.versions.cpv_getkey() " + \
