...
from pkgwh.cache.index.IndexStreamIterator import IndexStreamIterator
from pkgwh.cache.index.pkg_desc_index import \
...
class IndexedPortdb:
	...
	def match(self, atom):
		...
		if atom == atom.cp:
			return cp_list[:]
		return pkgwh.match_from_list(atom, cp_list)
