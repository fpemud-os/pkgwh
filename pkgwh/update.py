...
pkgwh.proxy.lazyimport.lazyimport(globals(),
	'pkgwh.dep:Atom,dep_getkey,isvalidatom,match_from_list',
	'pkgwh.util:ConfigProtect,new_protect_filename,' + \
		'normalize_path,write_atomic,writemsg',
	'pkgwh.versions:_get_slot_re',
)

from pkgwh.const import USER_CONFIG_PATH, VCS_DIRS
from pkgwh.eapi import _get_eapi_attrs
from pkgwh.exception import DirectoryNotFound, InvalidAtom, PortageException
...
def fixdbentries(update_iter, dbdir, eapi=None, parent=None):
	...
	warnings.warn("pkgwh.update.fixdbentries() is deprecated",
