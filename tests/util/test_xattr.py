...
"""Tests for the pkgwh.util._xattr module"""
...
from pkgwh.util._xattr import (xattr as _xattr, _XattrSystemCommands,
                                 _XattrStub)
...
def MockSubprocessPopen(stdin):
	...
	proc.stdin.write(pkgwh._unicode_encode(stdin, pkgwh._encodings['stdio']))
	return proc
