...
from pkgwh.data import pkgwh_gid, portage_uid
from pkgwh.package.ebuild.prepare_build_dirs import _ensure_log_subdirs
from pkgwh.util import apply_permissions, ensure_dirs, normalize_path
...
def process(mysettings, key, logentries, fulltext):
	...
	try:
		...
		if e.errno == errno.EACCES:
			...
			raise pkgwh.exception.ReadOnlyFileSystem(func_call)
		else:
			raise
