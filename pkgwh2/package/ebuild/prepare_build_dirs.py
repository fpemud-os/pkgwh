...
import pkgwh
from pkgwh import os, shutil, _encodings, _unicode_encode, _unicode_decode
...
def _prepare_fake_distdir(settings, alist):
	...
	pkgwh.util.ensure_dirs(edpath, gid=portage_gid, mode=0o755)
