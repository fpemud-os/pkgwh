...
pkgwh.proxy.lazyimport.lazyimport(globals(),
	'pkgwh.util.futures.unix_events:_PortageEventLoopPolicy',
	'pkgwh.util.futures:compat_coroutine@_compat_coroutine',
)
from pkgwh.util._eventloop.asyncio_event_loop import AsyncioEventLoop as _AsyncioEventLoop
# pylint: disable=redefined-builtin
from pkgwh.util.futures.futures import (
	CancelledError,
	Future,
	InvalidStateError,
	TimeoutError,
...
from pkgwh.util.futures._asyncio.process import _Process
from pkgwh.util.futures._asyncio.tasks import (
	ALL_COMPLETED,
	FIRST_COMPLETED,
	FIRST_EXCEPTION,
	wait,
...
def _safe_loop():
	...
	with _thread_weakrefs.lock:
		if _thread_weakrefs.pid != pkgwh.getpid():
			_thread_weakrefs.pid = pkgwh.getpid()
...
pkgwh.process.atexit_register(_thread_weakrefs_atexit)
