...
from pkgwh.const import EPREFIX
from pkgwh.dep.soname.multilib_category import compute_multilib_category
from pkgwh.dep.soname.SonameAtom import SonameAtom
from pkgwh.exception import CommandNotFound, InvalidData
from pkgwh.localization import _
from pkgwh.util import getlibpaths
from pkgwh.util import grabfile
from pkgwh.util import normalize_path
from pkgwh.util import varexpand
from pkgwh.util import writemsg_level
from pkgwh.util._dyn_libs.NeededEntry import NeededEntry
from pkgwh.util.elf.header import ELFHeader
...
# e_machine value which was used by earlier versions of pkgwh.
