...
pkgwh.proxy.lazyimport.lazyimport(globals(),
	'pkgwh.util.futures:asyncio',
	'pkgwh.util.futures.executor.fork:ForkExecutor',
	'pkgwh.util.futures.unix_events:_PortageEventLoop,_PortageChildWatcher',
)
...
class EventLoop:
	...
	def default_exception_handler(self, context):
		...
		os.kill(pkgwh.getpid(), signal.SIGTERM)
