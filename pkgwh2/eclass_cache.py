...
import errno
from pkgwh.exception import FileNotFound, PermissionDenied
from pkgwh import os
from pkgwh import checksum
...
class hashed_path:
	...
	def __repr__(self):
		return "<pkgwh.eclass_cache.hashed_path('%s')>" % (self.location,)
...
class cache:
	...
	def __init__(self, porttree_root, overlays=None):
		if overlays is not None:
			warnings.warn("overlays parameter of pkgwh.eclass_cache.cache constructor is deprecated and no longer used",
